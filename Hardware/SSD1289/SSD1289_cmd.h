...
#define SSD1289_VERT_SCROLL_1_VL1(n)		((n) & 0x1FF)

#define SSD1289_VERT_SCROLL_2				0x0042
#define SSD1289_VERT_SCROLL_2_VL2(n)		((n) & 0x1FF)
...
#define SSD1289_VERT_RAM_ADDR_STRT_POS_VSA(n)	((n) & 0x1FF)

#define SSD1289_VERT_RAM_ADDR_END_POS		0x0046
#define SSD1289_VERT_RAM_ADDR_END_POS_VEA(n)	((n) & 0x1FF)

#define SSD1289_FIRST_WND_START				0x0048
#define SSD1289_FIRST_WND_START_SS(n)		((n) & 0x1FF)

#define SSD1289_FIRST_WND_END				0x0049
#define SSD1289_FIRST_WND_END_SE(n)			((n) & 0x1FF)
